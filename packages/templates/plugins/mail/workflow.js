  ...
  nodes: [
    {
      ...
      properties: [
        { key: 'host', label: 'SMTP 服务器', type: 'text', required: true, default: '{{ __config__["workflow.mail"]["host"] }}' },
        { key: 'port', label: '端口', type: 'number', default: '{{ __config__["workflow.mail"]["port"] || 465 }}' },
        { key: 'user', label: '用户名', type: 'text', required: true, default: '{{ __config__["workflow.mail"]["user"] }}' },
        { key: 'pass', label: '密码/授权码', type: 'text', required: true, default: '{{ __config__["workflow.mail"]["pass"] }}' },
        { key: 'from', label: '发件人', type: 'text', default: '{{ __config__["workflow.mail"]["from"] }}', tooltip: '"名称 <地址>" 或纯地址' },
