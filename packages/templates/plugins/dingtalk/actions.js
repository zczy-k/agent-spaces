...
module.exports = (t) => [
  {
    ...
    properties: [
      ...
      { key: 'btns', label: t('field.btns.label', 'Multiple Buttons'), type: 'textarea', tooltip: t('field.btns.tooltip', 'Buttons JSON array') },
      { key: 'links', label: t('field.links.label', 'Feed List'), type: 'textarea', tooltip: t('field.links.tooltip', 'feedCard links JSON array') },
